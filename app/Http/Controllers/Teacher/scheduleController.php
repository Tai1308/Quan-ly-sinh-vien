...
class scheduleController extends Controller
{
    public function getTeachingSchedule()
    {
        ...
        $data_teacher       = DB::table('teacher')
                                ...
                                ->get();
    	return view('teacher.schedule.teachingSchedule',  [	
    ...
    public function postAddTeachingSchedule(Request $request)
    {
    	...
    	$studyTime			= $schedule->getIdStudyTime($request->id_studyTime);
    	...
    	{
    		return redirect("teacher/schedule/teachingSchedule")->with('loi','Thông tin đăng ký bắt buộc chọn đủ 3 trường: Giảng viên - Thời gian học - Ca học');
    	}
    	...
    	{
    		return redirect("teacher/schedule/teachingSchedule")->with('loi','Thông tin đăng ký thời gian học đã tồn tại');
    	}
    	else
    	{
    		...
    		return redirect("teacher/schedule/teachingSchedule")->with('thongbao','Đăng ký thành công'); 
    	}
    }
    ...
    public function postDeleteTeachingSchedule(Request $request)
    {
        ...
        return redirect("teacher/schedule/teachingSchedule")->with('thongbao', 'Xóa thời gian học thành công');        

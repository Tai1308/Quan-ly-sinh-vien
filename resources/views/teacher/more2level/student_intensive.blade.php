                ...
                <div class="col-sm-12">
                    ...
                    <div class="col-sm-9" style="margin-top: 10px;">
                        <div class="col-sm-4" style="margin-left: 41%">
                            <a href="teacher/more2level/courseIntensive/1" class="btn btn-success"><i class="fa fa-arrow-left" aria-hidden="true"></i> Khóa học</a>
                            <a href="teacher/more2level/addNewStudents" class="btn btn-success">Thêm mới</a>
...
{{--                         <div class="modal fade" id="addSTModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <form action="teacher/more2level/registerStudent" method="POST">
                                        {!! csrf_field() !!}

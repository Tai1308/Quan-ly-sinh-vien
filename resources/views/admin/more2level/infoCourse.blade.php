			        ...
			        <div class="col-md-11">
			            <div class="tab" role="tabpanel">
			                ...
			                <ul class="nav nav-tabs" role="tablist">
			                    <li role="presentation" class="{{ request()->get('active') != 'score' ? 'active' : '' }}"><a href="#Section1" aria-controls="home" role="tab" data-toggle="tab" class="tab_focus">Thông tin lớp học</a></li>
			                    ...
			                    <li role="presentation" class="{{ request()->get('active') == 'score' ? 'active' : '' }}"><a href="#Section8" aria-controls="messages" role="tab" data-toggle="tab" class="tab_focus">Quản lý điểm</a></li>
			                </ul>
			                <!-- Tab panes -->
			                <div class="tab-content">
			                	{{-- Thông tin lớp học --}}
			                    <div role="tabpanel" class="tab-pane fade {{ request()->get('active') != 'score' ? 'active in' : '' }}" id="Section1">
					                    ...
					                    <div class="form">
					                        <form class="cmxform form-horizontal " id="signupForm" method="" action="" novalidate="novalidate">
					                        	@foreach($courses as $course)
						                            ...
						                            <div class="form-group ">
						                                <label for="lastname" class="control-label col-lg-3">Tên lớp học</label>
						                                <div class="col-lg-8">
						                            ...
						                            <div class="form-group ">
						                                ...
						                                <div class="col-lg-8">
						                                    <input class="form-control " id="quantity_student" name="quantity_student" type="text" value="{{$count_student}}">
																				...
																				<div class="form-group ">
																					<label for="username" class="control-label col-lg-3">Học phí</label>
																					<div class="col-lg-8">
																						<input class="form-control " id="tuition" name="tuition" type="text" value="{{isset($course->tuition) ? $course->tuition : 1}}">
																					</div>
																				</div>
																				<div class="form-group ">
																					<label for="username" class="control-label col-lg-3">Mô tả khóa học</label>
																					<div class="col-lg-8">
																						<textarea name="notes" id="" cols="30" rows="10" class="form-control">{{isset($course->notes) ? $course->notes : 0}}</textarea>
																					</div>
																				</div>
					                            @endforeach
					                        </form>
			                    ...
			                    <div role="tabpanel" class="tab-pane fade" id="Section2">
			                        <div class="panel panel-default">
						                <div class="col-sm-12">
						                    <div class="div_87" style="margin-top: 10px;">
						                        
						                       {{--  Số buổi học --}}
						                        <div class="div_8765">
						                            <select class="form-control" id="buoihocSelect">
						                            	<option selected="">Chọn buổi học - Điểm danh</option>
						                        ...
						                        <div class="div_875" >
						                        	@foreach($courses as $course)
						                            <a href="admin/more2level/addNewStudents/{{$course->id}}" class="btn btn-success">Ghi danh</a>
						                      ...
						                      "enabled": true
						                        ...
						                        <thead>
						                            <tr>
						                                ...
						                                <th data-breakpoints="xs" class="t_table">Học phí</th>
						                                <th data-breakpoints="xs" class="t_table">Trạng thái</th>
						                                <th style="display: none;" id="td_thamgia" data-breakpoints="xs" class="t_table">Tham gia</th>
						                                <th data-breakpoints="xs" id="td_hanhdong">Hành động</th>
						                            </tr>
						                        </thead>
						                        <tbody id="tableBody">
						                           	@foreach($students as $student)
						                                <tr data-expanded="true">
															...
															<td class="t_table">{{ number_format($student->tuition) }}</td>
															<td class="t_table">
																<a href="{{ route('update.status.tuition', $student->id) }}" class="status_tuition">
																	<span class="text_status_tuition_{{ $student->id }}">{{ $student->status == 1 ? 'Đã nộp' : 'Chưa nộp' }}</span>
																</a>
															</td>
						                                    <td style="display: none;" class="t_table">
						                                    ...
						                                    <td>
						                                        ...
						                                        <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#deleteCourseModal{{$student->id}}" style="margin-left: 15px">
						                                            <i class="fa fa-trash-o" aria-hidden="true"></i>
						                                        </button>
						                                        {{-- modal xóa học viên --}}
						                                        <div class="modal fade" id="deleteCourseModal{{$student->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
						                                            <div class="modal-dialog" role="document">
						                                                <div class="modal-content">
						                                                    <div class="modal-header cus-modal-header">
						                                                        <h3 class="modal-title" id="exampleModalLabel">Xóa học viên trong danh sách lớp học</h3>
						                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
						                                                          <span aria-hidden="true">&times;</span>
						                                                        </button>
						                                                    </div>
						                                                    <form action="admin/more2level/deleteStudent/{{$student->id}}/{{$courseId}}" method="POST">
						                                                        <input type="hidden" name="_token" value="{{csrf_token()}}">
						                                                        <div class="modal-body">
						                                                            <p style="font-size: 20px"><b>Bạn muốn xóa:</b></p>
						                                                            <br>
						                                                            <p style="font-size: 15px">
						                                                                <i class="fa fa-user" aria-hidden="true"></i> 
						                                                                Học viên: {{$student->student_name}} 
						                                                            </p>
						                                                        </div>
						                            ...
						                            @endforeach
						                            <input type="hidden" name="check_display" id="check_display" value="0">
						                        </tbody>                  
						                    </table>
						                </div>
						            </div>
			                    ...
			                    <div role="tabpanel" class="tab-pane fade" id="Section4">
			                        <div class="panel-body">
					                    {{-- <div class="form"> --}}
					                        <form class="cmxform form-horizontal " method="post" action="admin/more2level/addPeriod">
					                        	{!! csrf_field() !!}
					                            <div class="form-group ">
					                                <label for="firstname" class="control-label col-lg-3">Buổi học</label>
					                                <div class="col-lg-8">
					                                    <input class=" form-control" id="period" name="period" type="number" value="" required="">
					                                </div>
					                            </div>
					                            <div class="form-group ">
					                                        ...
					                                        <div class="modal fade" id="deleteSTModal{{$period->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
					                                            <div class="modal-dialog" role="document">
					                                                <div class="modal-content">
					                                                    ...
					                                                    <form action="admin/more2level/deletePeriod" method="POST">
					                                                        <input type="hidden" name="_token" value="{{csrf_token()}}">
		                                        ...
		                                        <div class="modal fade" id="addDocModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		                                            <div class="modal-dialog" role="document">
		                                                <div class="modal-content">
		                                                    ...
		                                                    <form action="admin/more2level/addDocument" method="POST" enctype="multipart/form-data">
		                                                        <input type="hidden" name="_token" value="{{csrf_token()}}">
		                                                        <input type="hidden" name="courseId" value="{{$courseId}}" >
		                                                        <div class="modal-body">
		                                                            <div class="row">
						                                    ...
						                                    <div class="modal fade" id="updateExeModal{{$document->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
						                                        <div class="modal-dialog" role="document">
						                                            <div class="modal-content">
						                                                ...
						                                                <form action="admin/more2level/updateDocument" method="POST">
						                                                <input type="hidden" name="_token" value="{{csrf_token()}}">
						                                    ...
						                                    <div class="modal fade" id="deleteExeModal{{$document->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
						                                        <div class="modal-dialog" role="document">
						                                            <div class="modal-content">
						                                                ...
						                                                <form action="admin/more2level/deleteDocument" method="POST">
						                                                <input type="hidden" name="_token" value="{{csrf_token()}}">
						                                                <input type="hidden" name="document_id" value="{{$document->id}}">
						                                                <input type="hidden" name="courseId" value="{{$courseId}}" >
						                                                <div class="modal-body">
			                    ...
			                    {{-- Quản lý điểm --}}
			                    <div role="tabpanel" class="tab-pane fade {{ request()->get('active') == 'score' ? 'active in' : '' }}" id="Section8">
			                    	<div class="panel panel-default">
						                <table class="table" ui-jq="footable" ui-options='{
					                    "paging": {
					                      "enabled": true
						                                    ...
						                                    <div class="modal fade" id="updateScoreModal{{$hs->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
						                                        <div class="modal-dialog" role="document">
						                                            <div class="modal-content">
						                                                ...
						                                                <form action="admin/more2level/addScore/{{$hs->id}}" method="POST">
						                                                <input type="hidden" name="_token" value="{{csrf_token()}}">
						                                                <input type="hidden" name="courseId" value="{{$courseId}}">
						                                                <div class="modal-body">
				                                                            <div class="row">
						                                                    ...
						                                                    <div class="row">
						                                                        ...
						                                                        <div class="col-sm-8">
						                                                            <input type="number" class="form-control" id="writing_score" name="writing_score" value="{{$hs->score_writing}}">
						                                                        </div>
						                                                    </div>
						                                                    <div class="row">
						                                                        <div class="col-sm-4">
						                                                        ...
						                                                        <div class="col-sm-8">
						                                                            <input type="number" class="form-control" id="reading_score" name="reading_score" value="{{$hs->reading_score}}">
						                                                        </div>
						                                                    </div>
						                                                    <div class="row">
						                                                        <div class="col-sm-4">
						                                                        ...
						                                                        <div class="col-sm-8">
						                                                            <input type="number" class="form-control" id="speaking_score" name="speaking_score" value="{{$hs->speaking_score}}">
						                                                        </div>
						                                                    </div>
						                                                    <div class="row">
						                                                        <div class="col-sm-4">
						                                                        ...
						                                                        <div class="col-sm-8">
						                                                            <input type="number" class="form-control" id="listening_score" name="listening_score" value="{{$hs->listening_score}}">
						                                                        </div>
						                                                    </div>
				                                                        </div>
						                                                <div class="modal-footer">

                            ...
                            <div class="modal fade" id="addSTModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form action="admin/more2level/addIntensive" method="POST">
                                            {!! csrf_field() !!}
                                            <div class="modal-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <label for="phone" class="form_text">Học phí</label>
                                                    </div>
                                                    <div class="col-sm-8">
                                                        <input type="text" min="1" class="form-control" id="tuition" name="tuition" required="">
                                                    </div>
                                                </div>

                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <label for="phone" class="form_text">Số lượng học viên  </label>
                                                    </div>
                                                    <div class="col-sm-8">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <label for="phone" class="form_text">Mô tả khóa học </label>
                                                    </div>
                                                    <div class="col-sm-8">
                      ...
                      "enabled": true
                        ...
                        <thead>
                            <tr>
                                ...
                                <th data-breakpoints="xs" class="t_table">Tên lớp học</th>
                        ...
                        <tbody>
                            @foreach($courses as $key => $course)
                                <tr data-expanded="true">
                                    ...
                                    <td class="t_table">
                                        <a href="admin/more2level/infoCourse/{{$course->id}}">{{$course->name}}</a>
                                    </td>
                                    <td class="t_table">
                                        {{ number_format($course->tuition) }} đ
                                    </td>
                                    <td class="t_table">
                                        {{ $course->quantity }}
                                    </td>
                                    ...
                                    <td>
                                        {{-- <a href="admin/more2level/deleteIntensive/{{$course->id}}/{{$category_id}}" class="btn btn-danger">Xóa</a> --}}
                                        <!-- Modal start -->
                                        {{-- start xóa lớp học --}} 
                                        <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#deleteCourseModal{{$course->id}}" style="margin-left: 15px">
                                            <i class="fa fa-trash-o" aria-hidden="true"></i>
                                        </button>
                                        {{-- modal xóa lớp học --}}
                                        <div class="modal fade" id="deleteCourseModal{{$course->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header cus-modal-header">
                                                        <h3 class="modal-title" id="exampleModalLabel">Xóa lớp học</h3>
                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                          <span aria-hidden="true">&times;</span>
                                                        </button>
                                                    </div>
                                                    <form action="admin/more2level/deleteIntensive/{{$course->id}}/{{$category_id}}" method="POST">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <br>
                                                            <p style="font-size: 15px">
                                                                <i class="fa fa-calendar-o" aria-hidden="true"></i> Thời gian dự kiến: {{$course->startDate}} - {{$course->endDate}}
                                                            </p>
                                                        </div>
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-warning" data-dismiss="modal" >Hủy</button>

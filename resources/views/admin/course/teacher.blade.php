                                                ...
                                                <form action="admin/humanResources/addTeacher" method="POST">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input type="number" class="form-control" id="addIdTeacher" name="teacher_id" required="">
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-sm-4">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input type="number" class="form-control" id="addPhoneTeacher" name="phone" required="">
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-sm-4">

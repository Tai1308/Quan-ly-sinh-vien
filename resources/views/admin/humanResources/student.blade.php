                                                ...
                                                <form action="admin/humanResources/addStudent" method="POST">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input type="number" class="form-control" id="addIdStudent" name="student_id" required="">
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-sm-4">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input type="number" class="form-control" id="addPhoneStudent" name="phone" required="">
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-sm-4">

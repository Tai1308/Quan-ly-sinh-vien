            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="form">
                        ...
                        <form class="cmxform form-horizontal " id="signupForm" method="POST" action="admin/humanResources/postUpdateAccount/{{$du->id}}" novalidate="novalidate">
                        	{!! csrf_field() !!}
                            ...
                            {{-- <div class="form-group ">
                                ...
                                <div class="col-lg-8">
                                    <input class=" form-control" id="re_password" name="re_password" type="password" value="" style="margin-top: auto;">
                                </div>
                            </div> --}}
                            <div class="form-group">

				...
				<div class="col-lg-12 overview_test">
					<div class="col-lg-12 cover_header">
						...
						<div>
							...
							<div class="col-lg-4">
								<div>Phần thi viết: 
									@foreach($checkScoreWriting as $score)
										@if($score->score_writing == 0)
											<strong>Giáo viên chưa chấm phần thi này</strong>
										@elseif($score->score_writing != 0)
											<strong>{{$score->score_writing}}</strong>	
										@endif
									@endforeach
								</div>
							</div>
					...
					<div class="col-lg-12 cover_test">
						...
						<div class="col-lg-5">
							...
							<div class="tab-wrapper">
								...
								@foreach($history_writing as $hw)
								<div class="tab-content">
									<div class="tab-item" id="tab-main-info">
										<textarea class="do_writing" name="" id="" cols="48" rows="38">{{$hw->writing_task1}}
										</textarea>
									</div>
									<div class="tab-item" id="tab-image">
										<textarea class="do_writing" name="" id="" cols="48" rows="38">{{$hw->writing_task2}}
										</textarea>
									</div>
								</div>
								@endforeach
